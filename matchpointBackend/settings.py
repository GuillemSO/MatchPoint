"""
Django settings for matchpointBackend project.
...
DATABASES = {
    'default': {
        ...
        'PORT': '5433',  
        'OPTIONS': {
            'client_encoding': 'UTF8',  # Asegúrate de que esto esté configurado para UTF-8
        },
    }
}
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API para gestión de clubes, pistas, reservas y partidos',
    'VERSION': '1.0.0',
